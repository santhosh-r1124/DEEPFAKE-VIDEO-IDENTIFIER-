"""
NOXIS — EfficientNet-B3 Deepfake Detector
Mid-range CNN with temporal average pooling.
"""
...
class EfficientNetB3Detector(nn.Module):
    """
    EfficientNet-B3 → temporal average pool → classifier.
    Input : (B, T, C, H, W)
    Output: (B, 1)
    """
